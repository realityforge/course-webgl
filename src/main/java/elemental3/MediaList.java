 ...
 * @see <a href="https://drafts.csswg.org/cssom/#the-medialist-interface">The definition of 'MediaList' in CSS Object Model (CSSOM).</a>
 */
...
public class MediaList {
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-medialist-mediatext">The definition of 'mediaText' in CSS Object Model (CSSOM).</a>
   */
  @Nonnull
