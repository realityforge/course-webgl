 ...
 * @see <a href="https://drafts.csswg.org/cssom/#the-cssstylerule-interface">The definition of 'CSSStyleRule' in CSS Object Model (CSSOM).</a>
 * @see <a href="https://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSStyleRule">The definition of 'CSSRule' in Document Object Model (DOM) Level 2 Style Specification.</a>
 */
...
public class CSSStyleRule extends CSSRule {
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-cssstylerule-selectortext">The definition of 'CSSStyleRule.selectorText' in CSS Object Model (CSSOM).</a>
   */
  @Nonnull
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-cssstylerule-style">The definition of 'CSSStyleRule: style' in CSS Object Model (CSSOM).</a>
   */
  @JsProperty(
      name = "style"
  )
