 ...
 * @see <a href="https://encoding.spec.whatwg.org/#interface-textencoder">The definition of 'TextEncoder' in Encoding.</a>
 */
...
public class TextEncoder {
   ...
   * @see <a href="https://encoding.spec.whatwg.org/#dom-textencoder">The definition of 'TextEncoder()' in Encoding.</a>
   */
  public TextEncoder() {
  }
   ...
   * @see <a href="https://encoding.spec.whatwg.org/#dom-textencoder-encoding">The definition of 'TextEncoder.encoding' in Encoding.</a>
   */
  @JsProperty(
      name = "encoding"
  )
   ...
   * @see <a href="https://encoding.spec.whatwg.org/#dom-textencoder-encode">The definition of 'TextEncoder.prototype.encode()' in Encoding.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://encoding.spec.whatwg.org/#dom-textencoder-encodeinto">The definition of 'TextEncoder.encode()' in Encoding.</a>
   */
  @Nonnull
