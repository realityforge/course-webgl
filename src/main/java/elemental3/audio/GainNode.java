 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#gainnode">The definition of 'GainNode' in Web Audio API.</a>
 */
...
public class GainNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-gainnode-gainnode">The definition of 'GainNode()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-gainnode-gain">The definition of 'gain' in Web Audio API.</a>
   */
  @JsProperty(
      name = "gain"
  )
