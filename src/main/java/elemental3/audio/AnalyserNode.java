 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#analysernode">The definition of 'AnalyserNode' in Web Audio API.</a>
 */
...
public class AnalyserNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-fftsize">The definition of 'fftSize' in Web Audio API.</a>
   */
  public int fftSize;
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-maxdecibels">The definition of 'maxDecibels' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-mindecibels">The definition of 'minDecibels' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-smoothingtimeconstant">The definition of 'smoothingTimeConstant' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-analysernode">The definition of 'AnalyserNode() constructor' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-frequencybincount">The definition of 'frequencyBinCount' in Web Audio API.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-getbytefrequencydata">The definition of 'getByteFrequencyData()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-getbytetimedomaindata">The definition of 'getByteTimeDomainData()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-getfloatfrequencydata">The definition of 'getFloatFrequencyData()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-analysernode-getfloattimedomaindata">The definition of 'getFloatTimeDomainData()' in Web Audio API.</a>
   */
