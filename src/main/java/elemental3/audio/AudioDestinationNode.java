 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#AudioDestinationNode">The definition of 'AudioDestinationNode' in Web Audio API.</a>
 */
...
public class AudioDestinationNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiodestinationnode-maxchannelcount">The definition of 'maxChannelCount' in Web Audio API.</a>
   */
  @JsProperty(
