 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#AudioBufferSourceNode">The definition of 'AudioBufferSourceNode' in Web Audio API.</a>
 */
...
public class AudioBufferSourceNode extends AudioScheduledSourceNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-buffer">The definition of 'buffer' in Web Audio API.</a>
   */
  @Nullable
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-loop">The definition of 'loop' in Web Audio API.</a>
   */
  public boolean loop;
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-loopend">The definition of 'loopEnd' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-loopstart">The definition of 'loopStart' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-detune">The definition of 'detune' in Web Audio API.</a>
   */
  @JsProperty(
      name = "detune"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-playbackrate">The definition of 'playbackRate' in Web Audio API.</a>
   */
  @JsProperty(
      name = "playbackRate"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiobuffersourcenode-start">The definition of 'start()' in Web Audio API.</a>
   */
