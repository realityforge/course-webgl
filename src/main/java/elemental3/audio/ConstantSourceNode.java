 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#ConstantSourceNode">The definition of 'ConstantSourceNode' in Web Audio API.</a>
 */
...
public class ConstantSourceNode extends AudioScheduledSourceNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-constantsourcenode-constantsourcenode">The definition of 'ConstantSourceNode: ConstantSourceNode' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-constantsourcenode-offset">The definition of 'offset' in Web Audio API.</a>
   */
  @JsProperty(
      name = "offset"
  )
