 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#oscillatornode">The definition of 'OscillatorNode' in Web Audio API.</a>
 */
...
public class OscillatorNode extends AudioScheduledSourceNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-type">The definition of 'type' in Web Audio API.</a>
   */
  @Nonnull
  @OscillatorType
  public String type;
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-oscillatornode">The definition of 'OscillatorNode()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-detune">The definition of 'detune' in Web Audio API.</a>
   */
  @JsProperty(
      name = "detune"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-frequency">The definition of 'frequency' in Web Audio API.</a>
   */
  @JsProperty(
      name = "frequency"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-setperiodicwave">The definition of 'setPeriodicWave' in Web Audio API.</a>
   */
