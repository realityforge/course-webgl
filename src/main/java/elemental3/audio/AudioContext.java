 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#AudioContext">The definition of 'AudioContext' in Web Audio API.</a>
 */
...
public class AudioContext extends BaseAudioContext {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-audiocontext">The definition of 'AudioContext()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-baselatency">The definition of 'baseLatency' in Web Audio API.</a>
   */
  @JsProperty(
      name = "baseLatency"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-outputlatency">The definition of 'outputLatency' in Web Audio API.</a>
   */
  @JsProperty(
      name = "outputLatency"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-close">The definition of 'close()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-createmediaelementsource">The definition of 'createMediaElementSource()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-createmediastreamdestination">The definition of 'createMediaStreamDestination()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-createmediastreamsource">The definition of 'AudioContext.createMediaStreamSource()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-createmediastreamtracksource">The definition of 'createMediaStreamTrackSource()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-getoutputtimestamp">The definition of 'getOutputTimestamp()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-resume">The definition of 'resume()' in Web Audio API.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audiocontext-suspend">The definition of 'close()' in Web Audio API.</a>
   */
  @Nonnull
