 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#waveshapernode">The definition of 'WaveShaperNode' in Web Audio API.</a>
 */
...
public class WaveShaperNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-waveshapernode-curve">The definition of 'curve' in Web Audio API.</a>
   */
  @Nullable
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-waveshapernode-waveshapernode">The definition of 'WaveShaperNode()' in Web Audio API.</a>
   */
