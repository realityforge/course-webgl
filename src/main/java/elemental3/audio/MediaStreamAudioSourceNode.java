 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#mediastreamaudiosourcenode">The definition of 'MediaStreamAudioSourceNode' in Web Audio API.</a>
 */
...
public class MediaStreamAudioSourceNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-mediastreamaudiosourcenode-mediastreamaudiosourcenode">The definition of 'MediaStreamAudioSourceNode()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-mediastreamaudiosourcenode-mediastream">The definition of 'MediaStreamAudioSourceNode.mediaStream' in Web Audio API.</a>
   */
  @JsProperty(
      name = "mediaStream"
  )
