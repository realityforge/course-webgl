 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#OfflineAudioCompletionEvent">The definition of 'OfflineAudioCompletionEvent' in Web Audio API.</a>
 */
...
public class OfflineAudioCompletionEvent extends Event {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-offlineaudiocompletionevent-offlineaudiocompletionevent">The definition of 'OfflineAudioCompletionEvent()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-offlineaudiocompletionevent-renderedbuffer">The definition of 'renderedBuffer' in Web Audio API.</a>
   */
  @JsProperty(
      name = "renderedBuffer"
  )
