 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#stereopannernode">The definition of 'StereoPannerNode' in Web Audio API.</a>
 */
...
public class StereoPannerNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-stereopannernode-stereopannernode">The definition of 'StereoPannerNode()' in Web Audio API.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-stereopannernode-pan">The definition of 'pan' in Web Audio API.</a>
   */
  @JsProperty(
      name = "pan"
  )
