 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/scripting.html#htmlslotelement">The definition of 'HTMLSlotElement' in HTML Living Standard.</a>
 */
...
public class HTMLSlotElement extends HTMLElement {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-slot-name">The definition of 'name' in HTML Living Standard.</a>
   */
  @Nonnull
  public String name;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-slot-assignedelements">The definition of 'assignedElements()' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/scripting.html#dom-slot-assignednodes">The definition of 'assignedNodes' in HTML Living Standard.</a>
   */
  @Nonnull
