 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#videotracklist">The definition of 'VideoTrackList' in HTML Living Standard.</a>
 */
...
public class VideoTrackList extends EventTarget {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-tracklist-onaddtrack">The definition of 'VideoTrackList: onaddtrack' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-tracklist-onchange">The definition of 'VideoTrackList: onchange' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-tracklist-onremovetrack">The definition of 'VideoTrackList: onremovetrack' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotracklist-length">The definition of 'VideoTrackList: length' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "length"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotracklist-selectedindex">The definition of 'VideoTrackList: selectedIndex' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "selectedIndex"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotracklist-gettrackbyid">The definition of 'VideoTrackList.getTrackById()' in HTML Living Standard.</a>
   */
  @Nullable
