 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#videotrack">The definition of 'VideoTrack' in HTML Living Standard.</a>
 */
...
public class VideoTrack {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotrack-selected">The definition of 'VideoTrack: selected' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotrack-id">The definition of 'VideoTrack: id' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "id"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotrack-kind">The definition of 'VideoTrack: kind' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "kind"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotrack-label">The definition of 'VideoTrack: label' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "label"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-videotrack-language">The definition of 'VideoTrack: language' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "language"
  )
   ...
   * @see <a href="https://w3c.github.io/media-source/#dom-videotrack-sourcebuffer">The definition of 'VideoTrack: sourceBuffer' in Media Source Extensions.</a>
   */
  @JsProperty(
      name = "sourceBuffer"
  )
