 ...
 * @see <a href="https://drafts.csswg.org/cssom-view/#mediaquerylistevent">The definition of 'MediaQueryListEvent' in CSS Object Model (CSSOM) View Module.</a>
 */
...
public class MediaQueryListEvent extends Event {
   ...
   * @see <a href="https://drafts.csswg.org/cssom-view/#dom-mediaquerylistevent-mediaquerylistevent">The definition of 'MediaQueryListEvent()' in CSS Object Model (CSSOM) View Module.</a>
   */
   ...
   * @see <a href="https://drafts.csswg.org/cssom-view/#dom-mediaquerylistevent-matches">The definition of 'matches' in CSS Object Model (CSSOM) View Module.</a>
   */
  @JsProperty(
      name = "matches"
  )
   ...
   * @see <a href="https://drafts.csswg.org/cssom-view/#dom-mediaquerylistevent-media">The definition of 'media' in CSS Object Model (CSSOM) View Module.</a>
   */
  @JsProperty(
      name = "media"
  )
