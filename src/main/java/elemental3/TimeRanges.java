 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#time-ranges">The definition of 'TimeRanges' in HTML Living Standard.</a>
 */
...
public class TimeRanges {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-timeranges-length">The definition of 'TimeRanges.length()' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "length"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-timeranges-end">The definition of 'TimeRanges.end()' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-timeranges-start">The definition of 'TimeRanges.start()' in HTML Living Standard.</a>
   */
