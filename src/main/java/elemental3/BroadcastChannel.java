 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/comms.html#broadcastchannel">The definition of 'BroadcastChannel' in HTML Living Standard.</a>
 */
...
public class BroadcastChannel extends EventTarget {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/comms.html#handler-broadcastchannel-onmessage">The definition of 'BroadcastChannel.onmessage' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-broadcastchannel-onmessageerror">The definition of 'onmessageerror' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/comms.html#dom-broadcastchannel">The definition of 'BroadcastChannel()' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/comms.html#dom-broadcastchannel-name">The definition of 'BroadcastChannel.name' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "name"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/comms.html#dom-broadcastchannel-close">The definition of 'BroadcastChannel.close()' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/comms.html#dom-broadcastchannel-postmessage">The definition of 'BroadcastChannel.postmessage()' in HTML Living Standard.</a>
   */
