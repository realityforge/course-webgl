...
public class CSSStyleSheet extends StyleSheet {
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-cssstylesheet-cssrules">The definition of 'CSSStyleSheet.cssRules' in CSS Object Model (CSSOM).</a>
   */
  @JsProperty(
      name = "cssRules"
  )
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-cssstylesheet-ownerrule">The definition of 'CSSStyleSheet.ownerRule' in CSS Object Model (CSSOM).</a>
   */
  @JsProperty(
      name = "ownerRule"
  )
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-cssstylesheet-deleterule">The definition of 'CSSStyleSheet.deleteRule()' in CSS Object Model (CSSOM).</a>
   */
   ...
   * @see <a href="https://drafts.csswg.org/cssom/#dom-cssstylesheet-insertrule">The definition of 'CSSStyleSheet.insertRule' in CSS Object Model (CSSOM).</a>
   * @see <a href="https://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSStyleSheet-insertRule">The definition of 'CSSStyleSheet.insertRule' in Document Object Model (DOM) Level 2 Style Specification.</a>
   */
