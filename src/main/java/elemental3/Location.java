 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/browsers.html#the-location-interface">The definition of 'Location' in HTML Living Standard.</a>
 */
...
public class Location {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-hash">The definition of 'hash' in HTML Living Standard.</a>
   */
  @Nonnull
  public String hash;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-host">The definition of 'host' in HTML Living Standard.</a>
   */
  @Nonnull
  public String host;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-hostname">The definition of 'hostname' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-href">The definition of 'href' in HTML Living Standard.</a>
   */
  @Nonnull
  public String href;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-pathname">The definition of 'pathname' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-port">The definition of 'Location.port' in HTML Living Standard.</a>
   */
  @Nonnull
  public String port;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-protocol">The definition of 'protocol' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-search">The definition of 'search' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-ancestororigins">The definition of 'ancestorOrigins ' in HTML Living Standard.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-location-origin">The definition of 'origin' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "origin"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/history.html#dom-location-assign">The definition of 'Location.assign()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/browsers.html#dom-location-assign">The definition of 'Location.assign()' in HTML5.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/history.html#dom-location-reload">The definition of 'Location.reload()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/browsers.html#dom-location-reload">The definition of 'Location.reload()' in HTML5.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/history.html#dom-location-replace">The definition of 'Location.replace()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/browsers.html#dom-location-replace">The definition of 'Location.replace()' in HTML5.</a>
   */
