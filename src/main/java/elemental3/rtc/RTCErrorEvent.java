 ...
 * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcerrorevent">The definition of 'RTCErrorEvent' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
 */
...
public class RTCErrorEvent extends Event {
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcerrorevent-error">The definition of 'RTCErrorEvent.error' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
   */
  @JsProperty(
      name = "error"
  )
