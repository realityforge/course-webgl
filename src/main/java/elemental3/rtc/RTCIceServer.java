...
public interface RTCIceServer {
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtciceserver-credential">The definition of 'RTCIceServer.credential' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
   */
  @JsProperty(
      name = "credential"
  )
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtciceserver-urls">The definition of 'RTCIceServer.urls' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
   */
  @JsProperty(
      name = "urls"
  )
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtciceserver-username">The definition of 'RTCIceServer.username' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
   */
  @JsProperty(
      name = "username"
  )
