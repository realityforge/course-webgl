 ...
 * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcdtlstransport">The definition of 'RTCDtlsTransport' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
 */
...
public class RTCDtlsTransport extends EventTarget {
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcdtlstransport-icetransport">The definition of 'RTCDtlsTransport.iceTransport' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
   */
  @JsProperty(
      name = "iceTransport"
  )
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcdtlstransport-state">The definition of 'RTCDtlsTransport.state' in WebRTC 1.0: Real-time Communication Between Browsers.</a>
   */
  @JsProperty(
      name = "state"
  )
