 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#the-hashchangeevent-interface">The definition of 'HashChangeEvent' in HTML Living Standard.</a>
 */
...
public class HashChangeEvent extends Event {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-hashchangeevent-newurl">The definition of 'HashChangeEvent: newURL' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "newURL"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-hashchangeevent-oldurl">The definition of 'HashChangeEvent: oldURL' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "oldURL"
  )
