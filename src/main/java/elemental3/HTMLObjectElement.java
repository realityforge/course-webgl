 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#htmlobjectelement">The definition of 'HTMLObjectElement' in HTML Living Standard.</a>
 * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#the-object-element">The definition of 'HTMLObjectElement' in HTML5.</a>
 * @see <a href="https://www.w3.org/TR/DOM-Level-2-HTML/html.html#ID-9893177">The definition of 'HTMLObjectElement' in Document Object Model (DOM) Level 2 HTML Specification.</a>
 * @see <a href="https://www.w3.org/TR/REC-DOM-Level-1/level-one-html.html#ID-9893177">The definition of 'HTMLObjectElement' in Document Object Model (DOM) Level 1 Specification.</a>
 */
...
public class HTMLObjectElement extends HTMLElement {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-object-data">The definition of 'data' in HTML Living Standard.</a>
   */
  @Nonnull
  public String data;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-dim-height">The definition of 'height' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-object-name">The definition of 'name' in HTML Living Standard.</a>
   */
  @Nonnull
  public String name;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-object-type">The definition of 'type' in HTML Living Standard.</a>
   */
  @Nonnull
  public String type;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-object-usemap">The definition of 'useMap' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-dim-width">The definition of 'width' in HTML Living Standard.</a>
   */
  @Nonnull
  public String width;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-object-contentwindow">The definition of 'contentDocument' in HTML Living Standard.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-object-contentwindow">The definition of 'contentWindow' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "contentWindow"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-cva-validationmessage">The definition of 'validationMessage' in HTML Living Standard.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-cva-validity">The definition of 'validity' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "validity"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-cva-willvalidate">The definition of 'willValidate' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "willValidate"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-cva-checkvalidity">The definition of 'checkValidity' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-cva-setcustomvalidity">The definition of 'setCustomValidity' in HTML Living Standard.</a>
   */
