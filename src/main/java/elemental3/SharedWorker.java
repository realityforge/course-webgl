 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#sharedworker">The definition of 'SharedWorker' in HTML Living Standard.</a>
 */
...
public class SharedWorker extends EventTarget {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-sharedworker">The definition of 'SharedWorker()' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-sharedworker-port">The definition of 'AbstractWorker.onerror' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "port"
  )
