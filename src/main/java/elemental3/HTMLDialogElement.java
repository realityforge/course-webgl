...
public class HTMLDialogElement extends HTMLElement {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-dialog-open">The definition of 'open' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/interactive-elements.html#dom-htmldialogelement-open">The definition of 'open' in HTML 5.1.</a>
   */
  public boolean open;
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-dialog-returnvalue">The definition of 'returnvalue' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/interactive-elements.html#dom-htmldialogelement-returnvalue">The definition of 'returnvalue' in HTML 5.1.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-dialog-close">The definition of 'close()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/interactive-elements.html#dom-htmldialogelement-close">The definition of 'close()' in HTML 5.1.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-dialog-show">The definition of 'show()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/interactive-elements.html#dom-htmldialogelement-show">The definition of 'show()' in HTML 5.1.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-dialog-showmodal">The definition of 'showModal()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/interactive-elements.html#dom-htmldialogelement-showmodal">The definition of 'showModal()' in HTML 5.1.</a>
   */
