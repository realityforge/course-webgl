 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#radionodelist">The definition of 'RadioNodeList' in HTML Living Standard.</a>
 */
...
public class RadioNodeList extends NodeList {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-radionodelist-value">The definition of 'RadioNodeList.value' in HTML Living Standard.</a>
   */
  @Nonnull
  public String value;
