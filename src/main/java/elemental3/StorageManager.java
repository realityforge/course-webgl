 ...
 * @see <a href="https://storage.spec.whatwg.org/#storagemanager">The definition of 'StorageManger' in Storage.</a>
 */
...
public class StorageManager {
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storagemanager-estimate">The definition of 'estimate()' in Storage.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storagemanager-persist">The definition of 'persist' in Storage.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storagemanager-persisted">The definition of 'persisted' in Storage.</a>
   */
  @Nonnull
