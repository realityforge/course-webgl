 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/media.html#audiotrack">The definition of 'AudioTrack' in HTML Living Standard.</a>
 * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#audiotrack">The definition of 'AudioTrack' in HTML5.</a>
 */
...
public class AudioTrack {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/media.html#dom-audiotrack-enabled">The definition of 'AudioTrack.enabled' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#dom-audiotrack-enabled">The definition of 'AudioTrack.enabled' in HTML5.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/media.html#dom-audiotrack-id">The definition of 'AudioTrack.id' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#dom-audiotrack-id">The definition of 'AudioTrack.id' in HTML5.</a>
   */
  @JsProperty(
      name = "id"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/media.html#dom-audiotrack-kind">The definition of 'AudioTrack: kind' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#dom-audiotrack-kind">The definition of 'AudioTrack.kind' in HTML5.</a>
   */
  @JsProperty(
      name = "kind"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/media.html#dom-audiotrack-label">The definition of 'AudioTrack.label' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#dom-audiotrack-label">The definition of 'AudioTrack.label' in HTML5.</a>
   */
  @JsProperty(
      name = "label"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/media.html#dom-audiotrack-language">The definition of 'AudioTrack.language' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html52/embedded-content-0.html#dom-audiotrack-language">The definition of 'AudioTrack.language' in HTML5.</a>
   */
  @JsProperty(
      name = "language"
  )
   ...
   * @see <a href="https://w3c.github.io/media-source/#dom-audiotrack-sourcebuffer">The definition of 'AudioTrack: sourceBuffer' in Media Source Extensions.</a>
   */
  @JsProperty(
      name = "sourceBuffer"
  )
