 ...
 * @see <a href="https://storage.spec.whatwg.org/#dictdef-storageestimate">The definition of 'StorageEstimate' in Storage.</a>
 */
...
public interface StorageEstimate {
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storageestimate-quota">The definition of 'quota' in Storage.</a>
   */
  @JsProperty(
      name = "quota"
  )
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storageestimate-usage">The definition of 'usage' in Storage.</a>
   */
  @JsProperty(
      name = "usage"
  )
