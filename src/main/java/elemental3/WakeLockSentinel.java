 ...
 * @see <a href="https://w3c.github.io/screen-wake-lock/#the-wakelocksentinel-interface">The definition of 'WakeLockSentinel' in Screen Wake Lock API.</a>
 */
...
public class WakeLockSentinel extends EventTarget {
   ...
   * @see <a href="https://w3c.github.io/screen-wake-lock/#dom-wakelocksentinel-released">The definition of 'released' in Screen Wake Lock API.</a>
   */
  @JsProperty(
      name = "released"
  )
   ...
   * @see <a href="https://w3c.github.io/screen-wake-lock/#the-wakelocktype-enum">The definition of 'WakeLockType' in Screen Wake Lock API.</a>
   */
  @JsProperty(
      name = "type"
  )
   ...
   * @see <a href="https://w3c.github.io/screen-wake-lock/#the-release-method">The definition of 'release()' in Screen Wake Lock API.</a>
   */
  @Nonnull
