 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/webappapis.html#promiserejectionevent">The definition of 'PromiseRejectionEvent' in HTML Living Standard.</a>
 */
...
public class PromiseRejectionEvent extends Event {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#the-promiserejectionevent-interface">The definition of 'the PromiseRejectionEvent interface' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webappapis.html#dom-promiserejectionevent-promise">The definition of 'PromiseRejectionEvent.promise' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "promise"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webappapis.html#dom-promiserejectionevent-reason">The definition of 'PromiseRejectionEvent.reason' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "reason"
  )
