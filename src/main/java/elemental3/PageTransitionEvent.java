 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#the-pagetransitionevent-interface">The definition of 'PageTransitionEvent' in HTML Living Standard.</a>
 */
...
public class PageTransitionEvent extends Event {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-pagetransitionevent-persisted">The definition of 'PageTransitionEvent: persisted' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "persisted"
  )
