 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#htmllabelelement">The definition of 'HTMLLabelElement' in HTML Living Standard.</a>
 * @see <a href="https://www.w3.org/TR/html52/forms.html#the-label-element">The definition of 'HTMLLabelElement' in HTML5.</a>
 * @see <a href="https://www.w3.org/TR/DOM-Level-2-HTML/html.html#ID-13691394">The definition of 'HTMLLabelElement' in Document Object Model (DOM) Level 2 HTML Specification.</a>
 * @see <a href="https://www.w3.org/TR/REC-DOM-Level-1/level-one-html.html#ID-13691394">The definition of 'HTMLLabelElement' in Document Object Model (DOM) Level 1 Specification.</a>
 */
...
public class HTMLLabelElement extends HTMLElement {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-label-htmlfor">The definition of 'htmlFor' in HTML Living Standard.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-label-control">The definition of 'control' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "control"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/forms.html#dom-label-form">The definition of 'form' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "form"
  )
