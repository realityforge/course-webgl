 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#worker">The definition of 'Worker' in HTML Living Standard.</a>
 */
...
public class Worker extends EventTarget {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-abstractworker-onerror">The definition of 'AbstractWorker.onerror' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-worker-onmessage">The definition of 'Worker.onmessage' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-worker-onmessageerror">The definition of 'onmessageerror' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-worker">The definition of 'Worker()' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-worker-postmessage">The definition of 'Worker.postMessage()' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-worker-terminate">The definition of 'Worker.terminate()' in HTML Living Standard.</a>
   */
