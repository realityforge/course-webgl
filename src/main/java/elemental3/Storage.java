 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#storage">The definition of 'Storage' in HTML Living Standard.</a>
 */
...
public class Storage {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webstorage.html#dom-storage-length">The definition of 'Storage.length' in HTML Living Standard.</a>
   */
  @JsProperty(
      name = "length"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webstorage.html#dom-storage-clear">The definition of 'Storage.clear' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webstorage.html#dom-storage-key">The definition of 'Storage.key' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webstorage.html#dom-storage-getitem">The definition of 'Storage.getItem' in HTML Living Standard.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webstorage.html#dom-storage-setitem">The definition of 'Storage.setItem' in HTML Living Standard.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/webstorage.html#dom-storage-removeitem">The definition of 'Storage.removeItem' in HTML Living Standard.</a>
   */
