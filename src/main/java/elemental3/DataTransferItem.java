 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/interaction.html#datatransferitem">The definition of 'DataTransferItem' in HTML Living Standard.</a>
 * @see <a href="https://www.w3.org/TR/html51/editing.html#datatransferitem">The definition of 'DataTransferItem' in HTML 5.1.</a>
 * @see <a href="https://wicg.github.io/entries-api/#dom-datatransferitem-webkitgetasentry">The definition of 'DataTransferItem.webkitGetAsEntry()' in File and Directory Entries API.</a>
 */
...
public class DataTransferItem {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/interaction.html#dom-datatransferitem-kind">The definition of 'kind' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/editing.html#dom-datatransferitem-kind">The definition of 'kind' in HTML 5.1.</a>
   */
  @JsProperty(
      name = "kind"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/interaction.html#dom-datatransferitem-type">The definition of 'type' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/editing.html#dom-datatransferitem-type">The definition of 'type' in HTML 5.1.</a>
   */
  @JsProperty(
      name = "type"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/interaction.html#dom-datatransferitem-getasfile">The definition of 'getAsFile()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/editing.html#dom-datatransferitem-getasfile">The definition of 'getAsFile()' in HTML 5.1.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/interaction.html#dom-datatransferitem-getasstring">The definition of 'getAsString()' in HTML Living Standard.</a>
   * @see <a href="https://www.w3.org/TR/html51/editing.html#dom-datatransferitem-getasstring">The definition of 'getAsString()' in HTML 5.1.</a>
   */
