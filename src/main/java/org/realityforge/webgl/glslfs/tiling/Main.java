package org.realityforge.webgl.glslfs.tiling;
  ...
  implements EntryPoint
{
  ...
  private static final String FRAGMENT_SHADER_SOURCE =
    ...
    // We are tiling by multipling by 6 here and then using fract to just get fractional part
    // which essentially creates 6 ranges of 0-1 which means 6 shapes!
    "  vec2 tileFactor = vec2(6.0);" +
    "  vec2 uv = (gl_FragCoord.xy/u_resolution) * tileFactor;" +
    "  uv.x = fract(uv.x);" +
    "  uv.y = fract(uv.y);" +
