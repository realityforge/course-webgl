package org.realityforge.webgl.glslfs.double_square;
  ...
  implements EntryPoint
{
  ...
  private static final String FRAGMENT_SHADER_SOURCE =
    ...
    "  float square1LightFactor = inShape(uv, vec2(0.3), vec2(0.3, 0.5));" +
    "  vec3 square1Color = vec3(1.0, 1.0, 0.0);" +
    "  square1Color.x *= square1LightFactor;" +
    "  square1Color.y *= square1LightFactor;" +

    "  float square2LightFactor = inShape(uv, vec2(0.4, 0.4), vec2(0.8, 0.5));" +
    "  vec3 square2Color = vec3(0.0, 1.0, 0.0);" +
    "  square2Color.x *= square2LightFactor;" +
    "  square2Color.y *= square2LightFactor;" +

    "  color = vec4(square1Color + square2Color, 1.0);" +
    "}\n";
  @Nonnull
